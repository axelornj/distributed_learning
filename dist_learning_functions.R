...
#> q
#[,1]       [,2]
#x_0  1.7432498  0.6855471
#y_0 -0.2493625 -2.6649552
#> q[,1]
#x_0        y_0 
#1.7432498 -0.2493625 
...
grad_U <- function(q,t,j){
  ...
  if(r[i,j] < d0^2){
    ...
    if (i !=j){
      #print('RHO')
      #print(rho((sqrt(r[i,j])-d0)/(norm(d1-d0,type='2'))))
...
for(t in 1:num_it){
  for(i in 1:N){
    ...
    #print(P[i,t])
    #print(diag(t))
    #print(Phi(t,q_i,num_it))
    #print((diag(t)+Phi(t,q_i,num_it)%*%matrix(P[i,t])%*%t(Phi(t,q_i,num_it))^(-1)))
  ...
  #  print( q_list[[i]])
  #  print('grad U')
  #  print(grad_U(q_list,t,i))
  #  print('grad Psi')
  #  print(grad_Psi(q_list,p_list,i,t))
  #  print('phi Theta')
  #  print(t(phi(p_list[[i]][,t]))*Theta[t+1])
